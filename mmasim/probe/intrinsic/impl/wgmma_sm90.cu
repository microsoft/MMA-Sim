...
extern "C" // tf32
{
    ...
    void wgmma_m64n8k8_row_col_f32_tf32_tf32(
        float *d, uint32_t *a, uint32_t *b)
    {
        wgmma_m64n8k8_row_col_f32_tf32_tf32_kernel<<<1, 128>>>(d, a, b);
    }
}
...
extern "C" // fp16
{
    ...
    void wgmma_m64n8k16_row_col_f32_f16_f16(
        float *d, uint16_t *a, uint16_t *b)
    {
        wgmma_m64n8k16_row_col_f32_f16_f16_kernel<<<1, 128>>>(d, a, b);
    }

    void wgmma_m64n8k16_row_col_f16_f16_f16(
        uint16_t *d, uint16_t *a, uint16_t *b)
    {
        wgmma_m64n8k16_row_col_f16_f16_f16_kernel<<<1, 128>>>(d, a, b);
    }
}
...
extern "C" // bf16
{
    ...
    void wgmma_m64n8k16_row_col_f32_bf16_bf16(
        float *d, uint16_t *a, uint16_t *b)
    {
        wgmma_m64n8k16_row_col_f32_bf16_bf16_kernel<<<1, 128>>>(d, a, b);
    }
}

extern "C" // fp8 m64n8k32 f32_accum
{
    ...
    void wgmma_m64n8k32_row_col_f32_e5m2_e5m2(
        float *d, uint8_t *a, uint8_t *b)
    {
        wgmma_m64n8k32_row_col_f32_e5m2_e5m2_kernel<<<1, 128>>>(d, a, b);
    }

    void wgmma_m64n8k32_row_col_f32_e5m2_e4m3(
        float *d, uint8_t *a, uint8_t *b)
    {
        wgmma_m64n8k32_row_col_f32_e5m2_e4m3_kernel<<<1, 128>>>(d, a, b);
    }

    void wgmma_m64n8k32_row_col_f32_e4m3_e5m2(
        float *d, uint8_t *a, uint8_t *b)
    {
        wgmma_m64n8k32_row_col_f32_e4m3_e5m2_kernel<<<1, 128>>>(d, a, b);
    }

    void wgmma_m64n8k32_row_col_f32_e4m3_e4m3(
        float *d, uint8_t *a, uint8_t *b)
    {
        wgmma_m64n8k32_row_col_f32_e4m3_e4m3_kernel<<<1, 128>>>(d, a, b);
    }
}

extern "C" // fp8 m64n8k32 f16_accum
{
    ...
    void wgmma_m64n8k32_row_col_f16_e5m2_e5m2(
        uint16_t *d, uint8_t *a, uint8_t *b)
    {
        wgmma_m64n8k32_row_col_f16_e5m2_e5m2_kernel<<<1, 128>>>(d, a, b);
    }

    void wgmma_m64n8k32_row_col_f16_e5m2_e4m3(
        uint16_t *d, uint8_t *a, uint8_t *b)
    {
        wgmma_m64n8k32_row_col_f16_e5m2_e4m3_kernel<<<1, 128>>>(d, a, b);
    }

    void wgmma_m64n8k32_row_col_f16_e4m3_e5m2(
        uint16_t *d, uint8_t *a, uint8_t *b)
    {
        wgmma_m64n8k32_row_col_f16_e4m3_e5m2_kernel<<<1, 128>>>(d, a, b);
    }

    void wgmma_m64n8k32_row_col_f16_e4m3_e4m3(
        uint16_t *d, uint8_t *a, uint8_t *b)
    {
        wgmma_m64n8k32_row_col_f16_e4m3_e4m3_kernel<<<1, 128>>>(d, a, b);
    }
}

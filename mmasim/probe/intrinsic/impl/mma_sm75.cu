...
extern "C" // fp16
{
    ...
    void mma_m16n8k8_row_col_f16_f16_f16_f16(
        uint16_t *d, uint16_t *a, uint16_t *b, uint16_t *c)
    {
        mma_m16n8k8_row_col_f16_f16_f16_f16_kernel<<<1, 32>>>(d, a, b, c);
    }

    void mma_m16n8k8_row_col_f32_f16_f16_f32(
        float *d, uint16_t *a, uint16_t *b, float *c)
    {
        mma_m16n8k8_row_col_f32_f16_f16_f32_kernel<<<1, 32>>>(d, a, b, c);
    }
}
...
extern "C" void mma_m16n8k32_row_col_f32_e5m2_e5m2_f32(
    float *d, uint8_t *a, uint8_t *b, float *c)
{
    dim3 block(32);
    dim3 grid(1);
    mma_m16n8k32_row_col_f32_e5m2_e5m2_f32_kernel<<<grid, block>>>(d, a, b, c);
}

extern "C" void mma_m16n8k32_row_col_f32_e5m2_e4m3_f32(
    float *d, uint8_t *a, uint8_t *b, float *c)
{
    dim3 block(32);
    dim3 grid(1);
    mma_m16n8k32_row_col_f32_e5m2_e4m3_f32_kernel<<<grid, block>>>(d, a, b, c);
}

extern "C" void mma_m16n8k32_row_col_f32_e4m3_e5m2_f32(
    float *d, uint8_t *a, uint8_t *b, float *c)
{
    dim3 block(32);
    dim3 grid(1);
    mma_m16n8k32_row_col_f32_e4m3_e5m2_f32_kernel<<<grid, block>>>(d, a, b, c);
}

extern "C" void mma_m16n8k32_row_col_f32_e4m3_e4m3_f32(
    float *d, uint8_t *a, uint8_t *b, float *c)
{
    dim3 block(32);
    dim3 grid(1);
    mma_m16n8k32_row_col_f32_e4m3_e4m3_f32_kernel<<<grid, block>>>(d, a, b, c);
}
